        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="section-title  text-center">
                    <h2>Reviews</h2>
                    <span class="title-line"><i class="fa fa-star-o"></i></span>
                   <p>
            ...
            <div class="col-lg-12 col-sm-12">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        ...
                        <form action="#" method="post" id="rev-form" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="fname">Name:</label>
                                    <input type="text" class="form-control" id="fname" placeholder="Enter name" name="fname" required>
                                    <input type="hidden" name="website_id" value="{{$domain->id}}">

                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="suruname">Surname:</label>
                                    <input type="text" class="form-control" id="suruname" placeholder="Enter surname" name="surname" required>
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="booking_refrence">Booking Reference:</label>
                                    <input type="text" class="form-control" id="booking_refrence" placeholder="Enter Booking Reference" name="booking_refrence">
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="rate">Rate: <span class="bold rating-header" style="">
                                        <span class="selected-rating">0</span><small> / 5</small>
                                    </span></label>
                                    <span class="field-label-info"></span>
                                    <input type="text" style=" opacity: 0;width: 0; height: 0;" class="form-control" id="rate" value="" name="rate" required>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="col-lg-4 col-sm-4">
                        <div class="block-text rel zmin">
                            ...
                            <div class="mark">On <?php echo date("l jS F ", strtotime( $review->review_date )) ?> By {{ $review->fname }} </div>
                            <p>{{$review->review}}</p>
                            <ins class="ab zmin sprite sprite-i-triangle block"></ins>
                        </div>
                        <div class="person-text rel">
                            <img src="{{url("/img/user.png")}}"/>
                            <a title="" href="#">{{$review->fname}} {{$review->surname}}</a>
