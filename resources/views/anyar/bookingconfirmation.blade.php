    ...
    <div class="col-sm-8">
        <div class="section-title  text-center">
           ...
           <?php }else { ?>
            ...
            <?php } ?>
            <span class="title-line"><img style="width:45%;background: linear-gradient(#dc3545ed, #c6890f) !important;" src="/storage/uploads/{{$domain->website_logo}}"  class="img-responsive" style="width:50%" /></span>
        </div>
