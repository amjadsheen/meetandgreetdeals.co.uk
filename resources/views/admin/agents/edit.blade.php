                        ...
                        <div class="box-body">
                            ...
                            <!-- text input -->
                                ...
                                <div class="row">
                                    ...
                                    <?php  $temp =array('home'=> 'Home 1','home2'=> 'Home 2' )?>
                                    <div class="form-group col-sm-2">
                                        <label>HomePage Templete:</label>
                                ...
                                <div class="box box-success">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-2">
                                            <img style="width: 50%" src="{{url('/uploads/'.$website->website_logo)}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-2">
                                            <img style="width: 50%" src="{{url('/uploads/'.$website->website_banner)}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-2">
                                            <img style="width: 8%" src="{{url('/uploads/'.$website->website_favicon)}}">
                                        </div>
                                    </div>
                                </div>
