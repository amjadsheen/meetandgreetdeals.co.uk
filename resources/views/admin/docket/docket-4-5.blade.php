...
<table align="center" width="<?php echo $mtw ?>" border="0" cellpadding="2" cellspacing="0"
    ...
    <?php if(isset($docket) && ($docket == 5 )){  ?>
        ...
        <td width="30%" valign="top" style="position:relative;padding-right: 12px; border-right:thin; border-right-style:dashed; border-color:#A0A0A4;">
                            ...
                            <span class="<?php echo $print1; ?>" style="color:<?php echo $p1c; ?>;">
                                <div class="normal">
                                    ...
                                    echo '<span style="font-size: 15px;">' . strtoupper($payment_method) . '</span>'; ?>
                                        ...
                                        $TOTAL_PAYABLE_AMOUNT = $bookings->bk_total_amount + $carwash + $bookings->not_working_hours + $bookings->last_min_booking + $bookings->terminal_extra_charges + $bookings->charging_service_charges + $bookings->charging;
                                        //echo number_format($bookings->bk_total_amount, 2, '.', '');
                                        echo number_format($TOTAL_PAYABLE_AMOUNT, 2, '.', '');
                                        } else {
                                            $carwash = $bookings->carwash_in_and_out + $bookings->carwash_out_only + $bookings->carwash_in_only;
                                            $TOTAL_PAYABLE_AMOUNT = $bookings->bk_final_amount + $carwash + $bookings->not_working_hours + $bookings->last_min_booking + $bookings->terminal_extra_charges + $bookings->charging_service_charges + $bookings->charging;
            ...
            <div style="font-size:10px; color:<?php echo $color ?>;" class="<?php echo $print; ?>">
                By signing this document I agree that I have read the terms and conditions of <?php echo $bookings->website_name; ?> and agree
                ...
                <?php echo $bookings->website_name; ?> is not responsible for natural dirt caused by birds and weather.
            </div>
            <table style="font-size:<?php echo $tbl_font; ?>;" width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="<?php echo $color ?>">
                <tr height="<?php echo $rh1; ?>">
    ...
    <!--SECOND COLUMN START PAGE 1-->
        <td width="30%" valign="top" style="padding-left:6px; padding-right:6px; border-right:thin; border-right-style:dashed; border-color:#A0A0A4;">
            ...
            <div style="float:left1;" class="<?php echo $print; ?>">
                ...
                <div align="center" style="font-size:20px; color:<?php echo $color ?>;">020 3475 8556 / 020 7183
                    3455 (9AM to 5PM)<br/></div>

                <div align="center"><a  href="{{$bookings->website_url}}" class="<?php echo $print; ?>"
                style="color:<?php echo $lcolor; ?>;">{{$bookings->website_url}}</a>
                ...
                <div align="center" style="font-size:16px; color:<?php echo $color ?>;">{{$bookings->contact_num}} @if (trim($bookings->alternate_contact_num) !== '') / {{$bookings->alternate_contact_num}} @endif
                    5066<br/></div>
                <div style="font-size:16px;color:<?php echo $color ?>;"><strong>Duty Controller
...
<table align="center" width="1200" border="0" cellpadding="2" cellspacing="0" bordercolor="" <?php echo 'KKKKK-'.$docket. '-KKKKKK'; ?>>
    <tr>
        ...
        <td width="33%" valign="top" style="padding-right: 0; border-right:thin; border-right-style:dashed; border-color:#A0A0A4; text-align:center;">
            <img  class="<?php echo $print ?>" style=" "  width="86%" src="/storage/uploads/docket/col1page4.png"/><br/>
        </td>
        <td width="33%" valign="top" style="padding-right: 0; border-right:thin; border-right-style:dashed; border-color:#A0A0A4; text-align:center;">
            <img  class="<?php echo $print ?>" style=" "  width="86%" src="/storage/uploads/docket/col1page4.png"/><br/>
        </td>
