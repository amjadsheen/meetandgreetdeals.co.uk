...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <form method="post" style="float: right" action="{{ action('Admin\FixedPricesController@autogenerate') }}">
                @csrf
                ...
                <div class="col-md-12">
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <div class="box-body">
                                <form method="post"  action="{{ action('Admin\FixedPricesController@autogeneratefixedprices') }}">
                                @csrf
                                <!-- text input -->
...
{{--                                            @endforeach--}}
                                    ...
                                    <div class="form-group col-sm-1">
                                        <label>Days >=</label>
                                        <input type="number" min="1" max="30" class="form-control" name="start_day" required>
                                    </div>
                                                                                ...
                                                                                <tr id="row-{{$price->id}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <a class="testEdit" data-type="text" data-column="cal_d1"
                                                                                           data-url="{{route('booking-edit-fix-prices/updateinline', ['id'=>$price->id])}}"
